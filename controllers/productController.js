...
const getSingleProduct= async (req,res)=>{
    ...
    if(!product) throw new CustomError.NotFoundError(`No product with ID:${productId} exists`)
...
const deleteProduct= async (req,res)=>{
    ...
    res.status(StatusCodes.OK).json({msg:'Products have been succesfully removed!!'})
}
